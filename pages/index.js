  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="keywords"
          content="programador, freelancer, ingeniero, software, web, aplicaciones, fisico, matematico, freelance, diseño, paginas, CDMX, Mexico, puebla, cordoba, veracruz, andre, castellanos, C++, CUDA, python, react, backend"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="André Castellanos: Programador y físico-matemático"
        />
